...
- `Directory.Packages.props:57` — SixLabors.ImageSharp pinned to 2.1.13 and used for request-path image decoding. *Correction: do NOT move to 3.x — it is licensed under the Six Labors Split License (paid for commercial use), unsuitable for this freely-distributed library. Stay on the Apache-2.0 2.x line and keep it patched.*
