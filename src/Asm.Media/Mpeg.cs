...
public class Mpeg : MediaFile
{
    ...
    public bool Private
    {
        get { return _privateMarker; }
        set { _privateMarker = value; }
    }
    #endregion
    ...
    protected override void GetMetadata(Header parent, BinaryReader data, long start, long length, short headerOffset)
    {
        ...
        {
            ByteArray b = new(4, Endian.BigEndian);
            ...
            if (b.ToUInt32() == 435)
            {
                ...
                ExtendedBitArray mbits = new(heightwidth, Endian.BigEndian);
                ...
                ByteArray bitrate = new(3, Endian.BigEndian);
                data.Read(bitrate.GetBytes(), 0, 3);

                ExtendedBitArray mbitrate = new(bitrate.GetBytes(), Endian.BigEndian);
                ...
                ExtendedBitArray mAssortedInfo = new(assortedInfo, Endian.BigEndian);
                ...
                if (load_intra_quantizer_matrix)
                {
                    ...
                    ExtendedBitArray load_non_intra_quantizer_matrixCheck = new(lastByte, Endian.BigEndian);
                ...
                ByteArray b2 = new(4, Endian.BigEndian);
                ...
                if (this.MediaType == "MPEG2")
                {
                    ...
                    ExtendedBitArray extension_id_bits = new(extension_id_byte, Endian.BigEndian);
                    ...
                    if (extension_id == 1)
                    {
                        ...
                        ExtendedBitArray sequence_extension_bits = new(sequence_extension_bytes, Endian.BigEndian);
    ...
    */
    ...
    private void ParseFrequency(bool b1, bool b2)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    case "MPEG Version 1":
                        this._frequency = "44100";
                        break;
                    case "MPEG Version 2":
                        this._frequency = "22050";
                        break;
                    case "MPEG Version 2.5":
                        this._frequency = "11025";
                        break;
                }
            }
        }
    ...
    private void ParseModeExtension(bool b1, bool b2)
    {
        ...
        if (b1)
        {
            if (b2)
            {
                if (this._layer.Equals("Layer III"))
                {
                    // "11", L3
                    this._modeExtension = "IS+MS";
                }
                else
                {
                    // "11", L1 or L2
                    this._modeExtension = "16-31";
                }
            }
            else
            {
                ...
                {
                    // "10", L3
                    this._modeExtension = "MS";
                }
                else
                {
                    // "10", L1 or L2
                    this._modeExtension = "12-31";
                }
            }
        }
        else
        {
            if (b2)
            {
                ...
                {
                    // "01", L3
                    this._modeExtension = "IS";
                }
                else
                {
                    // "01", L1 or L2
                    this._modeExtension = "8-31";
                }
            }
            else
            {
    ...
    private void ParseEmphasis(bool b1, bool b2)
    {
        ...
        if (b1)
        {
            ...
            {
                //"11"
                this._emphasis = "CCIT J.17";
            }
            else
            {
                //"10"
                this._emphasis = "reserved";
            }
        }
        else
        {
    ...
    private void ParseChannelMode(bool b1, bool b2)
    {
        ...
        if (b1)
        {
            ...
            {
                //"11"
                this._channelMode = "Single Channel";
            }
            else
            {
                //"10"
                this._channelMode = "Dual Channel";
            }
        }
        else
        {
            ...
            {
                //"01"
                this._channelMode = "Joint Stereo";
            }
            else
            {
                //"00"
                this._channelMode = "Stereo";
            }
        }
    ...
    private void ParseVersion(bool b1, bool b2)
    {
        ...
        if (b1)
        {
            if (b2)
            {
                this._version = "MPEG Version 1";
            }
            else
            {
                this._version = "MPEG Version 2";
            }
        }
        else
        {
            if (b2)
            {
                this._version = "reserved";
            }
            else
            {
                this._version = "MPEG Version 2.5";
            }
        }
    ...
    private void ParseLayer(bool b1, bool b2)
    {
        ...
        else
        {
            ...
            {
                // "01"
                this._layer = "Layer III";
            }
            else
            {
                // "00"
                this._layer = "reserved";
            }
        }
    }
        ...
        if (b1)
        {
            if (b2)
            {
                if (b3)
                {
                    ...
                    {
                        #region "1110"
                        if (this._version.EndsWith("1"))
                        {
                            if (this._layer.EndsWith(" I"))
                            {
                                // V1, L1
                                this.Bitrate = 448;
                            }
                            else if (this._layer.EndsWith(" II"))
                            {
                                // v1, L2
                                this.Bitrate = 384;
                            }
    ...
    private byte[] FindAudioHeader(BinaryReader Data)
    {
        ...
        while (Data.BaseStream.Position < maxlength)
        {
            ...
            if (b.ToUInt32() == 448)
            {
                ...
                this._headerPosition = Data.BaseStream.Position;
